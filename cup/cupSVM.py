...
def main():
    ...
    with open("monkSVM_results.txt", "w") as results_file:
        for train_path, test_path in datasets:
            ...
            results_file.write(f"\n--- Esecuzione di Nested Grid Search utilizzando anche feature engeniring per il dataset {train_path} ---\n")
            nested_grid_search_kfold_with_feature_engineering(train_path, test_path, results_file)
            results_file.write("\n" + "-" * 50 + "\n")
